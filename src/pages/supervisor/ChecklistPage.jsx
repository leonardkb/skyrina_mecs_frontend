...
export default function ChecklistPage() {
  ...
  const fetchChecklist = async () => {
    try {
      const response = await axios.get('http://localhost:8000/supervisor/checklist/today')
  ...
  const fetchHistory = async () => {
    try {
      const response = await axios.get('http://localhost:8000/supervisor/checklist/history')
      if (response.data.success) {
  ...
  const submitChecklist = async () => {
    ...
    try {
      const response = await axios.post(
        'http://localhost:8000/supervisor/checklist/submit',
